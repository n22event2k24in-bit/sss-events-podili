            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <HiMail className="h-6 w-6 text-gray-600" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Email</h3>
                  <p className="text-gray-600">contact@sssevents.com</p>
                </div>
              </div>

              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <HiPhone className="h-6 w-6 text-gray-600" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0">
                  <HiLocationMarker className="h-6 w-6 text-gray-600" />
                </div>
                <div>
